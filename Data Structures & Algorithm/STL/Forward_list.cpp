...
void display(forward_list<int>&lst)
{
...
int main()
{
    ...
    forward_list<int> f1 = { 1, 2, 3, 2, 5, 6, 5, 5 };
    forward_list<int> f2 = { 11,12,13 };
    forward_list<int> f3 = { 101,102,103 };
    ...
    auto i = f1.begin();
    advance(i,2);
    f1.emplace_after(i,-101);
    display(f1);
    cout<<*i<<E;

    f1.insert_after(i,2,-99);
    display(f1);
    cout<<*i<<E;
