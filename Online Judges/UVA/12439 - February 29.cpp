...
int main()
{
    ...
    FTC(T)
    {
        ...
        cin >> mnth1 >> day1 >> c >> year1;
        cin >> mnth2 >> day2 >> c >> year2;

        if(mnth1!="January" && mnth1!="February")
            year1++;
        if(mnth2=="January" || (mnth2=="February" && day2<29))
            year2--;

        ll four = (year2/4)-((year1-1)/4);
        ll hund = (year2/100)-((year1-1)/100);
        ll fourhund = (year2/400)-((year1-1)/400);

        ll ans = four - hund + fourhund;
