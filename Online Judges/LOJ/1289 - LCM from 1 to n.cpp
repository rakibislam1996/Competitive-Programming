...
int main()
{
    ...
    FTC(T)
    {
        ...
        //ui index = upper_bound(all(prime),n) - prime.begin() - 1;
        ui index = upper_bound(prime,prime+cnt,n) - prime - 1;
        ui ans = solve(n) * p[index];
