...
int main()
{
    ...
    FTC(T)
    {
        ...
        //cout<<noOfprime(n,5)<<" "<<noOfprime(r,5)<<" "<<noOfprime(n-r,5)<<E;
        //cout<<noOfprime(n,2)<<" "<<noOfprime(r,2)<<" "<<noOfprime(n-r,2)<<E;

        ll ans1 = (noOfprime(n,5) + (trail0(p,5)*q)) - (noOfprime(r,5)+noOfprime(n-r,5));
        ll ans2 = (noOfprime(n,2) + (trail0(p,2)*q)) - (noOfprime(r,2)+noOfprime(n-r,2));
