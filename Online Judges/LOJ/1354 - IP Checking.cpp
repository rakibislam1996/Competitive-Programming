...
ll StoI(string s){ll ret;SS ss(s);ss >> ret;return ret;}
ull BtoD(string str){ull intS=0;int len=str.length();for(int i=0;str[i];i++)intS=(intS<<1)+(str[i]-'0');return intS;}
...
int main()
{
    ...
    FTC(T)
    {
        ...
        ll a[4],i,j=0,k=0,t=0,len=s1.length();
