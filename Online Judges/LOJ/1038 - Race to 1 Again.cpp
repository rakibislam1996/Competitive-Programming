...
/*
Divisors of D = 1,a1,a2,...,n
dp(D) = 1/n * (dp(D / 1) + 1)+ 1/n * (dp(D / a1) + 1) + 1/n * (dp(D / a3) + 1) ·······+ 1/n * (dp(D / n) + 1 );

dp(D) = (1/n)*dp(1) +  (1/n)*dp(a1)+ (1/n)*dp(a2)+ ... +(1/n)*dp(D) +1;

dp(D) = (1/n)[ dp(1) + dp(a1)+ dp(a2)+ ... + dp(D) + n ];

n * dp(D)=  dp(1) + dp(a1)+ dp(a2)+ ... + dp(D) + n ;

n * dp(D) - dp(D) =  dp(1) + dp(a1)+ dp(a2)+ ... + dp(an) + n ;

(n-1) * dp(D) =   dp(a1)+ dp(a2)+ ... + dp(an) + n ;    dp(1) = 0

dp(D) =1/(n-1)  *  [dp(a1)+ dp(a2)+ ... +dp(an) + n ]

every expected value will Add 1 because it takes one more step to become it
*/
