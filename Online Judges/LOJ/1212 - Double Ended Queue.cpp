        ...
        For(i,1,m)
        {
            ...
            if(s=="pushLeft")
            {
                if(dq.size()==n)
                    ...
                    dq.push_front(x),pf("Pushed in left: "),out(x),e;
            }
            else if(s=="pushRight")
            {
                if(dq.size()==n)
                    ...
                    dq.push_back(x),pf("Pushed in right: "),out(x),e;
            }
            else if(s=="popLeft")
            {
                if(dq.empty())
                    ...
                    pf("Popped from left: "),out(dq.front()),e,dq.pop_front();
            }
            else
            {
                if(dq.empty())
                    ...
                    pf("Popped from right: "),out(dq.back()),e,dq.pop_back();
            }
